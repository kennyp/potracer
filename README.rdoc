...
{<img src="https://travis-ci.org/kparnell/potracer.png" />}[https://travis-ci.org/kparnell/potracer] {<img src="https://codeclimate.com/github/kparnell/potracer.png" />}[https://codeclimate.com/github/kparnell/potracer] {<img src="https://coveralls.io/repos/kparnell/potracer/badge.png?branch=master" alt="Coverage Status" />}[https://coveralls.io/r/kparnell/potracer]
...
Feel free to post any issues to the {issue tracker}[https://github.com/kparnell/potracer/issues]
and {submit pull requests}[https://github.com/kparnell/potracer/pulls].
